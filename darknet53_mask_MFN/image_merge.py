...
if __name__ == '__main__':
    ...
    image_dir_path_without = r'D:\University\碩一上\人工智慧\Term Project\progress_check\one_stage_result\darknet53_mask_MFN\without_mask\detected'  # 图片集地址
    image_dir_path_with = r'D:\University\碩一上\人工智慧\Term Project\progress_check\one_stage_result\darknet53_mask_MFN\with_mask\detected'
    image_dir_path_incorrect = r'D:\University\碩一上\人工智慧\Term Project\progress_check\one_stage_result\darknet53_mask_MFN\mask_incorrectly\detected'

    image_size = 512  # 每张小图片的大小
    image_colnum = 5  # 合并成一张图后，一行有几个小图
    merge_images(image_dir_path_without, image_size, image_colnum)
    merge_images(image_dir_path_with, image_size, image_colnum)
    merge_images(image_dir_path_incorrect, image_size, image_colnum)