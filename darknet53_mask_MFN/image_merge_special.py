...
if __name__ == '__main__':
    ...
    image_dir_path_cloth = r'D:\University\碩一上\人工智慧\Term Project\progress_check\one_stage_result\darknet53_mask_MFN\special_mask\cloth_mask\detected'  # 图片集地址
    image_dir_path_n95 = r'D:\University\碩一上\人工智慧\Term Project\progress_check\one_stage_result\darknet53_mask_MFN\special_mask\n95_n99\detected'
    image_dir_path_scarf = r'D:\University\碩一上\人工智慧\Term Project\progress_check\one_stage_result\darknet53_mask_MFN\special_mask\scarf\detected'
    image_dir_path_transparent = r'D:\University\碩一上\人工智慧\Term Project\progress_check\one_stage_result\darknet53_mask_MFN\special_mask\transparent\detected'

    image_size = 512  # 每张小图片的大小
    image_colnum = 5  # 合并成一张图后，一行有几个小图
    merge_images(image_dir_path_cloth, image_size, image_colnum)
    merge_images(image_dir_path_n95, image_size, image_colnum)
    merge_images(image_dir_path_scarf, image_size, image_colnum)
    merge_images(image_dir_path_transparent, image_size, image_colnum)